...
type
   ...
   #TODO
   #Jack_thread_creator {.importc: "jack_thread_creator_t", header: jackh.} = proc(jack_native_thread_t *, pthread_attr_t *, void *(*function)(void *), void *arg): cint
...
proc jack_internal_client_handle *(client: PJackClient, client_name: cstring, status: ptr Jack_status, handle: Jack_intclient): cint {.importc: "jack_internal_client_handle ", header: jackh.}
# TODO
...
proc jack_ringbuffer_mlock*(rb: Jack_ringbuffer): cint {.importc: "jack_ringbuffer_mlock", header: jackh.}
...
proc jack_set_sync_timeout *(client: PJackClient, timeout: Jack_time): cint {.importc: "jack_set_sync_timeout ", header: jackh.}
...
proc jack_transport_locate *(client: PJackClient, frame: Jack_nframes): cint {.importc: "jack_transport_locate ", header: jackh.}
...
proc jack_transport_reposition *(client: PJackClient, pos: ptr Jack_position): cint {.importc: "jack_transport_reposition ", header: jackh.}
...
proc jack_acquire_real_time_scheduling *(thread: Jack_native_thread, priority: cint): cint {.importc: "jack_acquire_real_time_scheduling ", header: jackh.}
proc jack_client_create_thread *(client: PJackClient, thread: ptr Jack_native_thread, priority: cint, realtime: cint, start_routine: JackThreadFunction, arg: pointer): cint {.importc: "jack_client_create_thread ", header: jackh.}
proc jack_drop_real_time_scheduling *(thread: Jack_native_thread): cint {.importc: "jack_drop_real_time_scheduling ", header: jackh.}
#TODO
...
proc jack_midi_event_get*(event: Jack_midi_event, port_buffer: pointer, event_index: uint32): cint {.importc: "jack_midi_event_get ", header: jackh.}
...
proc jack_midi_event_write*(port_buffer: pointer, time: Jack_nframes, data: ptr Jack_midi_data, data_size: csize_t): cint {.importc: "jack_midi_event_write ", header: jackh.}
...
proc jack_session_reply*(client: PJackClient, event: ptr Jack_session_event): cint {.importc: "jack_session_reply ", header: jackh.}
...
proc jack_set_property*(client: PJack_client, subject: Jack_uuid, key, value, typ: cstring): cint {.importc: "jack_set_property", header: jackh.}
proc jack_get_property*(subject: Jack_uuid, key: cstring, value, typ: ptr cstring): cint {.importc: "jack_get_property", header: jackh.}
proc jack_free_description*(desc: ptr Jack_description, free_description_itself: cint) {.importc: "jack_free_description", header: jackh.}
proc jack_get_properties*(subject: Jack_uuid, desc: ptr Jack_description): cint {.importc: "jack_get_properties", header: jackh.}
proc jack_get_all_properties*(descs: ptr ptr Jack_description): cint {.importc: "jack_get_all_properties", header: jackh.}
proc jack_remove_property*(client: PJack_client, subject: Jack_uuid, key: cstring): cint {.importc: "jack_remove_property", header: jackh.}
proc jack_remove_properties*(client: PJack_client, subject: Jack_uuid): cint {.importc: "jack_remove_properties", header: jackh.}
proc jack_remove_all_properties*(client: PJack_client): cint {.importc: "jack_remove_all_properties", header: jackh.}
proc jack_set_property_change_callback *(client: PJack_client, cb: JackPropertyChangeCallback, arg: pointer): cint {.importc: "jack_set_property_change_callback ", header: jackh.}
