...
type
   ...
   JackLatencyRange* {.packed.} = object
       min, max: JackNFrames
   ...
   JackPortRegistrationCallback* = proc(port: JackPortId, r: cint, arg: pointer) {.cdecl.}
   JackClientRegistrationCallback* = proc(name: cstring, r: cint, arg: pointer) {.cdecl.}
   JackPortConnectCallback* = proc(a, b: JackPortId, connect: cint, arg: pointer) {.cdecl.}
   JackPortRenameCallback* = proc(port: JackPortId, old_name, new_name: cstring, arg: pointer) {.cdecl.}
   ...
   JackPosition {.importc: "jack_position_t", packed.} = object
      unique_1: JackUnique
      usecs: JackTime
      frame_rate: JackNFrames
      frame: JackNFrames
      ...
      frame_time: cdouble
      next_time: cdouble
      bbt_offset: JackNFrames
      audio_frames_per_video_frame: cfloat
      video_offset: JackNFrames
      padding1: int32
      padding2: int32
      padding3: int32
      padding4: int32
   ...
   JackSyncCallback {.importc, header: jackh.} = proc (state: JackTransportState, pos: ptr JackPosition, arg: pointer): cint

   JackTimebaseCallback {.importc, header: jackh.} = proc (state: JackTransportState, nframes: JackNFrames, pos: ptr JackPosition, new_pos: cint, arg: pointer)

   JackRingbufferData {.importc: "jack_ringbuffer_t", header: jackh.} = object
      buf: ptr char
      len: csize_t

   JackRingbuffer {.importc: "jack_ringbuffer_t", header: jackh.} = object
      buf: ptr char
      write_ptr, read_ptr, size, size_mask: csize_t
      mlocked: cint

   #TODO
   #JackThreadCreator {.importc: "jack_thread_creator_t", header: jackh.} = proc(jack_native_thread_t *, pthread_attr_t *, void *(*function)(void *), void *arg): cint
   ...
   JackctlParamType* {.importc: "jackctl_param_type_t".} = enum
      JackParamInt = 1,
      JackParamUInt,
      JackParamChar,
      JackParamString,
...
proc jack_client_open *(client_name: cstring, options: JackOptions, status: ptr JackStatus): PJackClient {.importc: "jack_client_open", header: jackh, varargs.}
proc jack_client_close*(client: PJackClient): cint {.importc: "jack_client_close", header: jackh.}
proc jack_client_name_size*(): cint {.importc: "jack_client_name_size", header: jackh.}
...
proc jack_thread_wait*(client: PJackClient, status: cint): JackNFrames {.importc: "jack_thread_wait", header: jackh.}
proc jack_cycle_wait*(client: PJackClient): JackNFrames {.importc: "jack_cycle_wait", header: jackh.}
proc jack_cycle_signal*(client: PJackClient, status: cint): void {.importc: "jack_cycle_signal", header: jackh.}
proc jack_set_process_thread*(client: PJackClient, thread_callback: JackThreadCallback, arg: pointer): cint {.importc: "jack_set_process_thread", header: jackh.}

# Setting Client Callbacks

proc jack_set_thread_init_callback*(client: PJackClient, thread_init_callback: JackThreadInitCallback, arg: pointer): cint {.importc: "jack_set_thread_init_callback", header: jackh.}
...
proc jack_set_process_callback*(client: PJackClient, process_callback: JackProcessCallback, arg: pointer): cint {.importc: "jack_set_process_callback", header: jackh.}
proc jack_set_freewheel_callback*(client: PJackClient, freewheel_callback: JackFreewheelCallback, arg: pointer): cint {.importc: "jack_set_freewheel_callback", header: jackh.}
proc jack_set_buffer_size_callback*(client: PJackClient, bufsize_callback: JackBufferSizeCallback, arg: pointer): cint {.importc: "jack_set_buffer_size_callback", header: jackh.}
proc jack_set_sample_rate_callback*(client: PJackClient, srate_callback: JackSampleRateCallback, arg: pointer): cint {.importc: "jack_set_sample_rate_callback", header: jackh.}
proc jack_set_client_registration_callback*(client: PJackClient, registration_callback: JackClientRegistrationCallback, arg: pointer): cint {.importc: "jack_set_client_registration_callback", header: jackh.}
proc jack_set_port_registration_callback*(client: PJackClient, registration_callback: JackPortRegistrationCallback, arg: pointer): cint {.importc: "jack_set_port_registration_callback", header: jackh.}
proc jack_set_port_connect_callback*(client: PJackClient, connect_callback: JackPortConnectCallback, arg: pointer): cint {.importc: "jack_set_port_connect_callback", header: jackh.}
proc jack_set_port_rename_callback*(client: PJackClient, rename_callback: JackPortRenameCallback, arg: pointer): cint {.importc: "jack_set_port_rename_callback", header: jackh.}
proc jack_set_graph_order_callback*(client: PJackClient, graph_callback: JackGraphOrderCallback, arg: pointer): cint {.importc: "jack_set_graph_order_callback", header: jackh.}
proc jack_set_xrun_callback*(client: PJackClient, xrun_callback: JackXRunCallback, arg: pointer): cint {.importc: "jack_set_xrun_callback", header: jackh.}
proc jack_set_latency_callback*(client: PJackClient, latency_callback: JackLatencyCallback, arg: pointer): cint {.importc: "jack_set_latency_callback", header: jackh.}

# Controlling & querying JACK server operation

proc jack_set_freewheel*(client: PJackClient, onoff: cint): cint {.importc: "jack_set_freewheel", header: jackh.}
proc jack_set_buffer_size*(client: PJackClient, nframes: JackNFrames): cint {.importc: "jack_set_buffer_size", header: jackh.}
...
proc jack_cpu_load*(client: PJackClient): cfloat {.importc: "jack_cpu_load", header: jackh.}

# Creating & manipulating ports

proc jack_port_register*(client: PJackClient, port_name: cstring, port_type: cstring, flags: culong, buffer_size: culong): PJackPort {.importc: "jack_port_register", header: jackh.}
proc jack_port_unregister*(client: PJackClient, port: PJackPort): cint {.importc: "jack_port_unregister", header: jackh.}
proc jack_port_get_buffer*(port: PJackPort, frames: JackNFrames): pointer {.importc: "jack_port_get_buffer", header: jackh.}
proc jack_port_uuid*(port: PJackPort): JackUuid {.importc: "jack_port_uuid", header: jackh.}
...
#TODO
#proc jack_port_get_aliases*(port: PJackPort, char* aliases[2]): cint
proc jack_port_request_monitor*(port: PJackPort, onoff: cint): cint {.importc: "jack_port_request_monitor", header: jackh.}
proc jack_port_request_monitor_by_name*(client: PJackClient, port_name: cstring, onoff: cint): cint {.importc: "jack_port_request_monitor_by_name", header: jackh.}
proc jack_port_ensure_monitor*(port: PJackPort, onoff: cint): cint {.importc: "jack_port_ensure_monitor", header: jackh.}
proc jack_port_monitoring_input*(port: PJackPort): cint {.importc: "jack_port_monitoring_input", header: jackh.}
proc jack_connect*(client: PJackClient,  source_port: cstring, destination_port: cstring): cint {.importc: "jack_connect", header: jackh.}
proc jack_disconnect*(client: PJackClient,  source_port: cstring, destination_port: cstring): cint {.importc: "jack_disconnect", header: jackh.}
proc jack_port_disconnect*(client: PJackClient, port: PJackPort): cint {.importc: "jack_port_disconnect", header: jackh.}
proc jack_port_name_size*(): cint {.importc: "jack_port_name_size", header: jackh.}
proc jack_port_type_size*(): cint {.importc: "jack_port_type_size", header: jackh.}
...
proc jack_port_get_latency_range*(port: PJackPort, mode: JackLatencyCallbackMode, range: ptr JackLatencyRange): void {.importc: "jack_port_get_latency_range", header: jackh.}
proc jack_port_set_latency_range*(port: PJackPort, mode: JackLatencyCallbackMode, range: ptr JackLatencyRange): void {.importc: "jack_port_set_latency_range", header: jackh.}
proc jack_recompute_total_latencies*(client: PJackClient): cint {.importc: "jack_recompute_total_latencies", header: jackh.}
...
proc jack_port_by_id*(client: PJackClient, port_id: JackPortId): PJackPort {.importc: "jack_port_by_id", header: jackh.}
...
proc jack_get_cycle_times*(client: PJackClient, current_frames: ptr JackNFrames, current_usecs: ptr JackTime, next_usecs: ptr JackTime, period_usecs: ptr cfloat): cint {.importc: "jack_get_cycle_times", header: jackh.}
...
proc jack_get_max_delayed_usecs*(client: PJackClient): cfloat {.importc: "jack_get_max_delayed_usecs", header: jackh.}
proc jack_get_xrun_delayed_usecs*(client: PJackClient): cfloat {.importc: "jack_get_xrun_delayed_usecs", header: jackh.}
proc jack_reset_max_delayed_usecs*(client: PJackClient) {.importc: "jack_reset_max_delayed_usecs", header: jackh.}

# Internal Client

proc jack_get_internal_client_name*(client: PJackClient, intclient: JackIntclient): cstring {.importc: "jack_get_internal_client_name", header: jackh.}
proc jack_internal_client_handle *(client: PJackClient, client_name: cstring, status: ptr JackStatus, handle: JackIntclient): cint {.importc: "jack_internal_client_handle ", header: jackh.}
# TODO
...
proc jack_internal_client_unload *(client: PJackClient, intclient: JackIntclient): JackOptions {.importc: "jack_internal_client_unload ", header: jackh.}

# Ring Buffer

proc jack_ringbuffer_create*(sz: csize_t): ptr JackRingbuffer {.importc: "jack_ringbuffer_create", header: jackh.}
proc jack_ringbuffer_free*(rb: JackRingbuffer) {.importc: "jack_ringbuffer_free", header: jackh.}
proc jack_ringbuffer_get_read_vector*(rb: JackRingbuffer, vec: ptr JackRingbufferData) {.importc: "jack_ringbuffer_get_read_vector", header: jackh.}
proc jack_ringbuffer_get_write_vector*(rb: JackRingbuffer, vec: ptr JackRingbufferData) {.importc: "jack_ringbuffer_get_write_vector", header: jackh.}
proc jack_ringbuffer_read*(rb: JackRingbuffer, dest: cstring, cnt: csize_t): csize_t {.importc: "jack_ringbuffer_read", header: jackh.}
proc jack_ringbuffer_peek*(rb: JackRingbuffer, dest: cstring, cnt: csize_t): csize_t {.importc: "jack_ringbuffer_peek", header: jackh.}
proc jack_ringbuffer_read_advance*(rb: JackRingbuffer, cnt: csize_t) {.importc: "jack_ringbuffer_read_advance", header: jackh.}
proc jack_ringbuffer_read_space*(rb: JackRingbuffer): csize_t {.importc: "jack_ringbuffer_read_space", header: jackh.}
proc jack_ringbuffer_mlock*(rb: JackRingbuffer): cint {.importc: "jack_ringbuffer_mlock", header: jackh.}
proc jack_ringbuffer_reset*(rb: JackRingbuffer) {.importc: "jack_ringbuffer_reset", header: jackh.}
proc jack_ringbuffer_write*(rb: JackRingbuffer, src: cstring, cnt: csize_t): csize_t {.importc: "jack_ringbuffer_write", header: jackh.}
proc jack_ringbuffer_write_advance*(rb: JackRingbuffer, cnt: csize_t) {.importc: "jack_ringbuffer_write_advance", header: jackh.}
proc jack_ringbuffer_write_space*(rb: JackRingbuffer): csize_t {.importc: "jack_ringbuffer_write_space", header: jackh.}

# Transport

proc jack_release_timebase *(client: PJackClient): cint {.importc: "jack_release_timebase ", header: jackh.}
proc jack_set_sync_callback *(client: PJackClient, sync_callback: JackSyncCallback, arg: pointer): cint {.importc: "jack_set_sync_callback ", header: jackh.}
proc jack_set_sync_timeout *(client: PJackClient, timeout: JackTime): cint {.importc: "jack_set_sync_timeout ", header: jackh.}
proc jack_set_timebase_callback *(client: PJackClient, conditional: cint, timebase_callback: JackTimebaseCallback, arg: pointer): cint {.importc: "jack_set_timebase_callback ", header: jackh.}
proc jack_transport_locate *(client: PJackClient, frame: JackNFrames): cint {.importc: "jack_transport_locate ", header: jackh.}
proc jack_transport_query *(client: PJackClient, pos: ptr JackPosition): JackTransportState {.importc: "jack_transport_query ", header: jackh.}
proc jack_get_current_transport_frame *(client: PJackClient): JackNFrames {.importc: "jack_get_current_transport_frame ", header: jackh.}
proc jack_transport_reposition *(client: PJackClient, pos: ptr JackPosition): cint {.importc: "jack_transport_reposition ", header: jackh.}
...
proc jack_client_real_time_priority *(client: PJackClient): cint {.importc: "jack_client_real_time_priority ", header: jackh.}
proc jack_client_max_real_time_priority *(client: PJackClient): cint {.importc: "jack_client_max_real_time_priority ", header: jackh.}
proc jack_acquire_real_time_scheduling *(thread: JackNativeThread, priority: cint): cint {.importc: "jack_acquire_real_time_scheduling ", header: jackh.}
proc jack_client_create_thread *(client: PJackClient, thread: ptr JackNativeThread, priority: cint, realtime: cint, start_routine: JackThreadFunction, arg: pointer): cint {.importc: "jack_client_create_thread ", header: jackh.}
proc jack_drop_real_time_scheduling *(thread: JackNativeThread): cint {.importc: "jack_drop_real_time_scheduling ", header: jackh.}
#TODO
#void 	jack_set_thread_creator *(jack_thread_creator_t creator)

# Reading and writing MIDI data

proc jack_midi_get_event_count*(port_buffer: pointer): JackNFrames {.importc: "jack_midi_get_event_count", header: jackh.}
proc jack_midi_event_get*(event: JackMidiEvent, port_buffer: pointer, event_index: uint32): cint {.importc: "jack_midi_event_get ", header: jackh.}
...
proc jack_midi_event_reserve*(port_buffer: pointer, time: JackNFrames, data_size: csize_t): ptr JackMidiData {.importc: "jack_midi_event_reserve ", header: jackh.}
proc jack_midi_event_write*(port_buffer: pointer, time: JackNFrames, data: ptr JackMidiData, data_size: csize_t): cint {.importc: "jack_midi_event_write ", header: jackh.}
proc jack_midi_get_lost_event_count*(port_buffer: pointer): uint32 {.importc: "jack_midi_get_lost_event_count ", header: jackh.}

# Sessions

proc jack_set_session_callback*(client: PJackClient, session_callback: JackSessionCallback, arg: pointer): cint {.importc: "jack_set_session_callback ", header: jackh.}
proc jack_session_reply*(client: PJackClient, event: ptr JackSessionEvent): cint {.importc: "jack_session_reply ", header: jackh.}
proc jack_session_event_free*(event: ptr JackSessionEvent) {.importc: "jack_session_event_free ", header: jackh.}
...
proc jackctl_parameter_get_type*(parameter: JackctlParameter): JackctlParamType {.importc: "jackctl_parameter_get_type ", header: jackh.}
...
proc jackctl_parameter_set_value*(parameter: JackctlParameter, value_ptr: ptr JackctlParameterValue): bool {.importc: "jackctl_parameter_set_value", header: jackh.}
